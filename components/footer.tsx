        ...
        <div className="flex flex-col items-center text-center gap-6">
          ...
          <div className="flex gap-4 text-foreground/70">
            <AnalyticsLink
              ...
              eventProperties={{ destination: "instagram", placement: "footer" }}
            ...
            <AnalyticsLink
              ...
              rel="me noopener noreferrer"
              eventName="external_profile_click"
              eventProperties={{ destination: "linkedin", placement: "footer" }}
              className="hover:text-accent transition-colors"
              aria-label="LinkedIn"
            >
              <Linkedin size={18} />
            ...
            <AnalyticsLink
              ...
              eventProperties={{ method: "whatsapp", placement: "footer" }}
              className="hover:text-accent transition-colors"
              aria-label="WhatsApp"
            >
              <svg
